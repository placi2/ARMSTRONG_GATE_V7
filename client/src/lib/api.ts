...
export const api={
  ...
  getEquipmentStock:()=>r<any[]>("GET","/equipment/stock"),getSiteStock:()=>r<any[]>("GET","/equipment-site-stock"),transferToSite:(d:any)=>r<any>("POST","/equipment-site-stock/transfer",d),getEquipmentTransfers:()=>r<any[]>("GET","/equipment-transfers"),getEquipmentMovements:()=>r<any[]>("GET","/equipment-movements"),getAttendance:()=>r<any[]>("GET","/attendance"),saveAttendance:(records:any[])=>r<any>("POST","/attendance",{records}),getSalaryDeductions:()=>r<any[]>("GET","/salary-deductions"),paySalaryDeduction:(id:string,amount:number)=>r<any>("PUT",`/salary-deductions/${id}/pay`,{amount}),createSortie:(d:any)=>r<any>("POST","/equipment-movements/sortie",d),createRetour:(id:string,d:any)=>r<any>("PUT",`/equipment-movements/${id}/retour`,d),getEquipment:()=>r<any[]>("GET","/equipment"),createEquipment:(e:any)=>r<any>("POST","/equipment",e),updateEquipment:(id:string,e:any)=>r<any>("PUT",`/equipment/${id}`,e),deleteEquipment:(id:string)=>r<any>("DELETE",`/equipment/${id}`),
  ...
  getRequests:()=>r<any[]>("GET","/requests"),createRequest:(d:any)=>r<any>("POST","/requests",d),updateRequestStatus:(id:string,status:string)=>r<any>("PUT",`/requests/${id}`,{status}),updateRequest:(id:string,data:any)=>r<any>("PUT",`/requests/${id}`,data),saveRentalDetails:(id:string,data:any)=>r<any>("PUT",`/requests/${id}/rental-details`,data),
