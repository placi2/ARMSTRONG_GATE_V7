...
export const api={
  ...
  getEquipmentStock:()=>r<any[]>("GET","/equipment/stock"),getSiteStock:()=>r<any[]>("GET","/equipment-site-stock"),transferToSite:(d:any)=>r<any>("POST","/equipment-site-stock/transfer",d),getEquipmentTransfers:()=>r<any[]>("GET","/equipment-transfers"),getEquipment:()=>r<any[]>("GET","/equipment"),createEquipment:(e:any)=>r<any>("POST","/equipment",e),updateEquipment:(id:string,e:any)=>r<any>("PUT",`/equipment/${id}`,e),deleteEquipment:(id:string)=>r<any>("DELETE",`/equipment/${id}`),
