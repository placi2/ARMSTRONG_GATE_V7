...
export const api={
  ...
  getRequests:()=>r<any[]>("GET","/requests"),createRequest:(d:any)=>r<any>("POST","/requests",d),updateRequestStatus:(id:string,status:string)=>r<any>("PUT",`/requests/${id}`,{status}),updateRequest:(id:string,data:any)=>r<any>("PUT",`/requests/${id}`,data),
