...
interface Ctx{
  ...
  requests:any[];addRequest:(r:any)=>Promise<void>;updateRequestStatus:(id:string,status:string)=>Promise<void>;updateRequest:(id:string,data:any)=>Promise<void>;
...
export function DataProvider({children}:{children:React.ReactNode}){
  ...
  return<DataContext.Provider value={{
    ...
    addEquipment,updateEquipment,deleteEquipment,addAdvance,deleteAdvance,updateGoldStock,requests,addRequest,updateRequestStatus,updateRequest,
